    ...
    <>
      <section className="px-5 md:px-20">
        <article className="grid grid-cols-1 lg:grid-cols-2 md:flex-row mt-8 bg-secondary px-10">
          <div className="py-8  md:px-10 font-acumin ">
        ...
        <article className="grid grid-cols-1 font-acumin md:grid-cols-1  lg:grid-cols-3 mt-10 gap-5 ">
          <div className="bg-background px-2  md:px-10 py-10">
            <h1 className="text-secondary text-3xl md:text-5xl font-bold">
              {t("ourValuesTitle3")}
            </h1>
            <p className="text-justify mt-5">{t("ourValuesParagraph3")}</p>
          </div>
          <div className="bg-others px-2  md:px-10 py-10">
      ...
      <article className="bg-main text-default font-acumin text-center mt-10 py-4 text-lg md:text-2xl">
